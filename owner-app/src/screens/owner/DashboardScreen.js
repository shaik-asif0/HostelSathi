    ...
    <View style={styles.card}>
      ...
      <View style={styles.cardStatsRow}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => navigation.navigate('ReviewsManagement', { hostelId: item._id })}
        >
          ...
          <View style={styles.drawerContent}>
            <View style={styles.drawerHeader}>
              ...
              <TouchableOpacity onPress={() => setIsDrawerOpen(false)} style={styles.drawerCloseBtn}>
                <Ionicons name="close" size={28} color="#1e1b29" />
              </TouchableOpacity>
            </View>
            
            <ScrollView style={styles.drawerLinks}>
              <TouchableOpacity style={styles.drawerLink} onPress={() => setIsDrawerOpen(false)}>
                <Ionicons name="home-outline" size={22} color="#4F46E5" style={styles.drawerIcon} />
                <Text style={[styles.drawerLinkText, { color: '#4F46E5', fontWeight: 'bold' }]}>Dashboard</Text>
              </TouchableOpacity>
              
              <TouchableOpacity style={styles.drawerLink} onPress={() => { setIsDrawerOpen(false); navigation.navigate('ReviewsManagement'); }}>
                <Ionicons name="star-outline" size={22} color="#4b5563" style={styles.drawerIcon} />
                <Text style={styles.drawerLinkText}>Reviews</Text>
              </TouchableOpacity>
              
              <TouchableOpacity style={styles.drawerLink} onPress={() => { setIsDrawerOpen(false); navigation.navigate('PremiumPromotion'); }}>
                <Ionicons name="megaphone-outline" size={22} color="#4b5563" style={styles.drawerIcon} />
                <Text style={styles.drawerLinkText}>Boost Hostel</Text>
              </TouchableOpacity>

              <TouchableOpacity style={styles.drawerLink} onPress={() => { setIsDrawerOpen(false); navigation.navigate('PaymentHistory'); }}>
                <Ionicons name="receipt-outline" size={22} color="#4b5563" style={styles.drawerIcon} />
                <Text style={styles.drawerLinkText}>Payment History</Text>
              </TouchableOpacity>

              <TouchableOpacity style={styles.drawerLink} onPress={() => setIsDrawerOpen(false)}>
                <Ionicons name="person-outline" size={22} color="#4b5563" style={styles.drawerIcon} />
                <Text style={styles.drawerLinkText}>Profile</Text>
              </TouchableOpacity>

              <TouchableOpacity style={styles.drawerLink} onPress={() => setIsDrawerOpen(false)}>
                <Ionicons name="settings-outline" size={22} color="#4b5563" style={styles.drawerIcon} />
                <Text style={styles.drawerLinkText}>Settings</Text>
              </TouchableOpacity>
            </ScrollView>

            <TouchableOpacity style={styles.drawerLogout} onPress={() => setIsDrawerOpen(false)}>
              <Ionicons name="log-out-outline" size={22} color="#ef4444" style={styles.drawerIcon} />
