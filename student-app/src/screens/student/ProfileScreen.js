      ...
      <View style={styles.whiteBodyContainer}>
        ...
        {!isOwner && (
          <View style={styles.statsRow}>
            ...
            <View style={styles.statCard}>
              ...
              <Text style={styles.statNum}>{visits?.length || 0}</Text>
            </View>
            <View style={styles.statCard}>
              <Text style={styles.statLabel}>Reviews</Text>
              <Text style={styles.statNum}>{user?.reviews || 0}</Text>
            </View>
          </View>
        )}

        {/* Owner Stats Fallback */}
        {isOwner && (
          <View style={styles.statsRow}>
            <View style={styles.statCard}>
              <Text style={styles.statLabel}>Hostels</Text>
              <Text style={styles.statNum}>{hostels?.filter(h => h.owner === user._id).length || 0}</Text>
            </View>
            <View style={styles.statCard}>
              <Text style={styles.statLabel}>Leads</Text>
              <Text style={styles.statNum}>{user?.leads || 0}</Text>
            </View>
            <View style={styles.statCard}>
              <Text style={styles.statLabel}>Rating</Text>
              <Text style={styles.statNum}>{user?.rating || "N/A"}</Text>
            </View>
          </View>
        )}
        ...
        <View style={styles.menuList}>
          <TouchableOpacity style={styles.menuItemRow} onPress={handleOpenEdit} activeOpacity={0.6}>
            <Ionicons name="pencil-outline" size={22} color="#4b5563" style={styles.menuIcon} />
          ...
          {!isOwner && (
            <>
              <TouchableOpacity style={styles.menuItemRow} onPress={() => Alert.alert('Coming Soon', 'Your bookings history will appear here.')} activeOpacity={0.6}>
                <Ionicons name="calendar-outline" size={22} color="#4b5563" style={styles.menuIcon} />
                <Text style={styles.menuItemText}>My Bookings</Text>
                <Ionicons name="chevron-forward" size={20} color="#9ca3af" />
              </TouchableOpacity>

              <TouchableOpacity style={styles.menuItemRow} onPress={() => Alert.alert('Coming Soon', 'Your reviews will appear here.')} activeOpacity={0.6}>
                <Ionicons name="star-outline" size={22} color="#4b5563" style={styles.menuIcon} />
                <Text style={styles.menuItemText}>My Reviews</Text>
                <Ionicons name="chevron-forward" size={20} color="#9ca3af" />
              </TouchableOpacity>

              <TouchableOpacity style={styles.menuItemRow} onPress={() => setReferralModalVisible(true)} activeOpacity={0.6}>
                <Ionicons name="gift-outline" size={22} color="#4b5563" style={styles.menuIcon} />
          ...
          {isOwner && (
            <>
              <TouchableOpacity style={styles.menuItemRow} onPress={() => navigation.navigate("Dashboard")} activeOpacity={0.6}>
                <Ionicons name="stats-chart-outline" size={22} color="#4b5563" style={styles.menuIcon} />
                <Text style={styles.menuItemText}>My Dashboard</Text>
                <Ionicons name="chevron-forward" size={20} color="#9ca3af" />
              </TouchableOpacity>

              <TouchableOpacity style={styles.menuItemRow} onPress={() => navigation.navigate("AddHostel")} activeOpacity={0.6}>
                <Ionicons name="add-circle-outline" size={22} color="#4b5563" style={styles.menuIcon} />
                <Text style={styles.menuItemText}>Manage Hostels</Text>
                <Ionicons name="chevron-forward" size={20} color="#9ca3af" />
              </TouchableOpacity>
            </>
          )}
